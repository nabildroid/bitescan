...
Future<void> assetsDataGenerator() async {
  var data = jsonEncode(_foods.map((e) => e.toJson()).toList());
  final dir = Directory("assets/data");
  await dir.create(recursive: true);

  var file = File("${dir.path}/foods.json");
  await file.writeAsString(data);

  data = jsonEncode(_goals.map((e) => e.toJson()).toList());
